...
public class DateUtil {
    private static final int [] DAYS_OF_MOTHS = {0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
    ...
    {
        return month == 2 && isLeapYear(year) ? 29 : DAYS_OF_MOTHS[month];
    }
